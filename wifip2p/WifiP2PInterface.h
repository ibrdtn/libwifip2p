...
namespace wifip2p
{
	...
	public:
		 ...
		 *
		 */
		virtual void connectionRequest(const Peer &peer) = 0;
		 ...
		 *
		 */
		virtual void connectionEstablished(const Connection &conn) = 0;
		 ...
		 *
		 */
		virtual void connectionLost(const Connection &conn) = 0;
	};
} /* namespace wifip2p */
